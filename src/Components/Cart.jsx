export default function Cart({ open, cart }) { /* CONECTAMOS nuestro state cart nuestro carrito de compras */
      ...
      >
        ...
        <div id="carrito" className="table">
          {isEmpty() ? (
            ...
            <table className="table-content"> {/* aqui inicia nuestra tabla */}
              <thead> {/* encabezado  */}
